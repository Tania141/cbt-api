...
from cbt_docx import (
    two_names, one_and_three, fmt_date,
    extract_employees, extract_projectants, by_spec,
    build_vazlogitel_block, build_projectants_list, build_employees_list,
    build_projectants_signatures, build_employees_signatures,
    build_placeholders,
    insert_paragraphs_after, replace_in_runs, fill_template,
)
...
TEMPLATE_FILES = {
    ...
    "akt9":        "Akt_9_Template.docx",
    "beton_dnevnik": "Akt_9_Beton_Dnevnik_Template.docx",
    "akt10":       "Akt_10_Template.docx",
    "akt11":       "Akt_11_Template.docx",
    "akt12":       "Akt_12_Template.docx",
...
DOC_TYPE_CONTEXT = {
    ...
    "akt5":        "Акт за уточняване и съгласуване на строителния терен с одобрения инвестиционен проект и даване на основен репер на строежа (Приложение №5, т. 5)",
    "akt6":        "Акт за приемане на земната основа и действителните коти на извършените изкопни работи (Приложение №6, т. 6)",
    "akt7":        "Акт за приемане на извършените строителни и монтажни работи по нива и елементи на строителната конструкция (Приложение №7, т. 7)",
    "akt8":        "Акт за приемане и предаване на бетонни, стоманобетонни или други фундаменти за монтаж на конструкции, машини и съоръжения (Приложение №8, т. 8)",
    "akt9":        "Акт за предаване и приемане на машини и съоръжения (Приложение №9, т. 9)",
    "beton_dnevnik": "Бетонов дневник — дневник за бетонови работи (НЕ е Приложение №9 към Наредба №3)",
    "akt10":       "Акт за установяване състоянието на строежа при спиране на строителството (Приложение №10, т. 10)",
    "akt11":       "Акт за установяване състоянието на строежа и строителните и монтажните работи при продължаване на строителството (Приложение №11, т. 11)",
    "akt12":       "Акт за установяване на всички видове СМР, подлежащи на закриване, удостоверяващ, че са постигнати изискванията на проекта (Приложение №12, т. 12)",
    "akt13":       "Акт за установяване на щети, причинени от непреодолима природна сила и др. (Приложение №13, т. 13)",
    "akt14":       "Акт за приемане на конструкцията (Приложение №14, т. 14)",
